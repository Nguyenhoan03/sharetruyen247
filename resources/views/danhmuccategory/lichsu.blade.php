...
<head>
    <meta charset="UTF-8">
   <title>truyenhay247-Tổng hợp truyện lịch sử hay và mới nhất</title>
            ...
            <div class="row align-items-start">
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="section-stories-new mb-3">
                                ...
                                <div style="width:100%" class="col-6 col-md-4 col-lg-4 head-title-global__left d-flex align-items-center">
                                    <h2 style="width:100%" class="me-2 mb-0 border-bottom border-secondary pb-1">
                                        <a href="https://suustore.com/#"
                                            ...
                                            title="Truyện Mới">Truyện Lịch Sử</a>
                                    </h2>
                        ...
                        <div class="contentdm">
                            <div>
                            <button onclick="handlefull()">truyện lịch sử full</button>
                            <button onclick="handlehot()">truyện lịch sử hot</button>
                            </div>
                            <div class="lkdjf">
                            @foreach($data as $dt)
