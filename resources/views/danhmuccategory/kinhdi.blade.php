...
<head>
    <meta charset="UTF-8">
   <title>truyenhay247-Tổng hợp truyện kinh dị hay và mới nhất</title>
    ...
    <main>
        ...
        <div class="container">
                ...
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="section-stories-new mb-3">
                                ...
                                <div style="width:100%" class="col-6 col-md-4 col-lg-4 head-title-global__left d-flex align-items-center">
                                    <h2 style="width:100%" class="me-2 mb-0 border-bottom border-secondary pb-1">
                                        <a href="https://suustore.com/#"
                                            ...
                                            title="Truyện Mới">Truyện Kinh Dị</a>
                                    </h2>
                        ...
                        <div class="contentdm">
                            ...
                            <button onclick="handlefull()">truyện kinh dị full</button>
                            <button onclick="handlehot()">truyện kinh dị hot</button>
                            </div>
            ...
            <div class="section-list-category bg-light p-2 rounded card-custom">
               ...
               <p>Danh sách những truyện Linh Dị huyền huyễn, hài hước, thần quái, thai rắn được chọn lọc kể về những câu truyện thần bí và không kém phần rùng rợn kinh dị.</p>  
