...
<head>
    <meta charset="UTF-8">
   <title>truyenhay247-Tổng hợp truyện ma hay và mới nhất</title>
...
@include('danhmuccategory.header')
    ...
    <main>
        ...
        <div class="container">
            <div class="row align-items-start">
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="section-stories-new mb-3">
                                ...
                                <div style="width:100%" class="col-6 col-md-4 col-lg-4 head-title-global__left d-flex align-items-center">
                                    <h2 style="width:100%" class="me-2 mb-0 border-bottom border-secondary pb-1">
                                        <a href="https://suustore.com/#"
                                            ...
                                            title="Truyện Mới">Truyện Truyện Ma</a>
                                    </h2>
                        ...
                        <div class="contentdm">
                            <div>
                            <button onclick="handlefull()">truyện truyện ma full</button>
                            <button onclick="handlehot()">truyện truyện ma hot</button>
                            </div>
                            <div class="lkdjf">
                            @foreach($data as $dt)
            ...
            <p>Thể loại truyện đô thị kể về cuộc sống của những con người trong thế giới hiện nay, những mối quan hệ tình cảm phức tạp và những âm mưu hiểm ác hấp dẫn lắm.
</p>
                        </div>
                    </div>
                </div>
