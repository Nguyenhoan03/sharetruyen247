...
<head>
    <meta charset="UTF-8">
   <title>truyenhay247-Tổng hợp truyện ngôn tình hay và mới nhất</title>
    ...
    <main>
        ...
        <div class="container">
            <div class="row align-items-start">
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="section-stories-new mb-3">
                                ...
                                <div style="width:100%" class="col-6 col-md-4 col-lg-4 head-title-global__left d-flex align-items-center">
                                    <h2 style="width:100%" class="me-2 mb-0 border-bottom border-secondary pb-1">
                                        <a href="https://suustore.com/#"
                                            ...
                                            title="Truyện Mới">Truyện Ngôn Tình</a>
                                    </h2>
                        ...
                        <div class="contentdm">
                            <div>
                            <button onclick="handlefull()">truyện ngôn tình full</button>
                            <button onclick="handlehot()">truyện ngôn tình hot</button>
                            </div>
                            <div class="lkdjf">
                            @foreach($data as $dt)
            ...
            <div class="section-list-category bg-light p-2 rounded card-custom">
              ...
              <p>List tiểu thuyết truyện ngôn tình hay đã hoàn và nhiều truyện mới cập nhật, ngược, sủng, hiện đại, cổ đại, full trên trang đọc truyện ngôn tình hàng đầu Việt Nam. Dưới đây là các thể loại Truyện Ngôn Tình được bạn đọc quan tâm nhất: ngôn tình hoàn, ngôn tình ngược, ngôn tình sủng, ngôn tình hiện đại, ngôn tình cổ đại, ngôn tình sắc
</p>
                        </div>
                    </div>
                </div>
