...
<head>
    <meta charset="UTF-8">
   <title>truyenhay247-Tổng hợp truyện khoa huyễn hay và mới nhất</title>
    ...
    <main>
        ...
        <div class="container">
                ...
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="section-stories-new mb-3">
                                ...
                                <div style="width:100%" class="col-6 col-md-4 col-lg-4 head-title-global__left d-flex align-items-center">
                                    <h2 style="width:100%" class="me-2 mb-0 border-bottom border-secondary pb-1">
                                        <a href="https://suustore.com/#"
                                            ...
                                            title="Truyện Mới">Truyện Khoa Huyễn</a>
                                    </h2>
                        ...
                        <div class="contentdm">
                            ...
                            <button onclick="handlefull()">truyện Khoa Huyễn full</button>
                            <button onclick="handlehot()">truyện Khoa Huyễn hot</button>
                            </div>
            ...
            <div class="section-list-category bg-light p-2 rounded card-custom">
               ...
               <p>Thể loại truyện Khoa Huyễn với những tình tiết lâm ly bi đát và những phút giây hồi hộp quấn hút người đọc cũng như những nhân vật xử lý tài tình.
</p>
                        </div>
                    </div>
                </div>
