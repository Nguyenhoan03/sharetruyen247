...
<head>
    <meta charset="UTF-8">
    <title>truyenhay247-Tổng hợp truyện đam mỹ hay và mới nhất</title>
                                ...
                                <div style="width:100%" class="col-6 col-md-4 col-lg-4 head-title-global__left d-flex align-items-center">
                                    <h2 style="width:100%" class="me-2 mb-0 border-bottom border-secondary pb-1">
                                        <a href="https://suustore.com/#"
                                            ...
                                            title="Truyện Mới">Truyện Đam Mỹ</a>
                                    </h2>
                            ...
                            <div class="section-list-category bg-light p-2 rounded card-custom">
                                ...
                                <div class="row">
                                    <div class="overviewtienhiep">
                                        <p>Thể loại truyện Đam Mỹ lãng mạn dành cho các bạn đọc đam mê với những tuyển tập mới, hay nhất được cập nhật thường xuyên và vô vàn về loại như: ngược, sủng, trọng sinh, h tục sm, tổng tài, vườn trường mời bạn khám phá.
                                        </p>
                                    </div>
                                </div>
                            </div>
