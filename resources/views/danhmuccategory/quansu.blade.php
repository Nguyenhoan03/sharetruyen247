...
<head>
    <meta charset="UTF-8">
   <title>truyenhay247-Tổng hợp truyện quân sư hay và mới nhất</title>
...
@include('danhmuccategory.header')
    ...
    <main>
        ...
        <div class="container">
                ...
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="section-stories-new mb-3">
                                ...
                                <div style="width:100%" class="col-6 col-md-4 col-lg-4 head-title-global__left d-flex align-items-center">
                                    <h2 style="width:100%" class="me-2 mb-0 border-bottom border-secondary pb-1">
                                        <a href="https://suustore.com/#"
                                            ...
                                            title="Truyện Mới">Truyện Quân Sư</a>
                                    </h2>
                        ...
                        <div class="contentdm">
                            ...
                            <button onclick="handlefull()">truyện quân sư full</button>
                            <button onclick="handlehot()">truyện quân sư hot</button>
                            </div>
           ...
           <p>Thể loại truyện quân sự kể về những cuộc chiến tranh lịch sử và những người tài sử dụng quân cũng như chiến thuật trọng các cuộc đấu tranh dành quyền.
</p>
                        </div>
                    </div>
                </div>
