...
<head>
    <meta charset="UTF-8">
   <title>truyenhay247-Tổng hợp truyện teen hay và mới nhất</title>
    ...
    <main>
        ...
        <div class="container">
            <div class="row align-items-start">
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="section-stories-new mb-3">
                                ...
                                <div style="width:100%" class="col-6 col-md-4 col-lg-4 head-title-global__left d-flex align-items-center">
                                    <h2 style="width:100%" class="me-2 mb-0 border-bottom border-secondary pb-1">
                                        <a href="https://suustore.com/#"
                                            ...
                                            title="Truyện Mới">Truyện Teen</a>
                                    </h2>
                        ...
                        <div class="contentdm">
                            <div>
                            <button onclick="handlefull()">truyện teen full</button>
                            <button onclick="handlehot()">truyện teen hot</button>
                            </div>
                            <div class="lkdjf">
                            @foreach($data as $dt)
            ...
            <div class="section-list-category bg-light p-2 rounded card-custom">
               ...
               <p>Thể loại truyện teen hay mới nhất hiện nay đã full được chọn lọc từ những truyện tình yêu tuổi học trò dễ thương và hồn nhiên trong sáng.</p>  
