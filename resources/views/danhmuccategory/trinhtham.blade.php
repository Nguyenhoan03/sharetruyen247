...
<head>
    <meta charset="UTF-8">
   <title>truyenhay247-Tổng hợp truyện trinh thám hay và mới nhất</title>
...
@include('danhmuccategory.header')
    ...
    <main>
        ...
        <div class="container">
                ...
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="section-stories-new mb-3">
                                ...
                                <div style="width:100%" class="col-6 col-md-4 col-lg-4 head-title-global__left d-flex align-items-center">
                                    <h2 style="width:100%" class="me-2 mb-0 border-bottom border-secondary pb-1">
                                        <a href="https://suustore.com/#"
                                            ...
                                            title="Truyện Mới">Truyện Trinh Thámc</a>
                                    </h2>
                        ...
                        <div class="contentdm">
                            ...
                            <button onclick="handlefull()">truyện trinh thám full</button>
                            <button onclick="handlehot()">truyện trinh thám hot</button>
                            </div>
                            <div class="lkdjf">
                            @foreach($data as $dt)
           ...
           <p>Đọc truyện trinh thám hay và mới nhất chuyên dành cho những người yêu thích phá án, thích suy luận về những vụ án mạng ly kỳ và nhiều bỉ ẩn bên cạnh vụ án.
</p>
                        </div>
                    </div>
                </div>
