...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  @if(Session::has('naplinhthachthanhcong'))
    <div class="alert alert-success" style="margin-top:15px">
        {{ Session::get('naplinhthachthanhcong') }}
    </div>
@endif
      ...
      <div class="col-md-12">
        <div class="app-title">
          <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><a href=""><b>Thông tin người dùng</b></a></li>
          </ul>
</div>
...
<table>
    ...
    @foreach($data as $dt)
        ...
        <tr>
            ...
            <td>{{ $dt->linh_thach }}</td>
            <td>
                <a href="/pageadmin/adminnaplinhthachforuser/{{$dt->id}}" class="btn btn-success">Nạp linh thạch</a>
