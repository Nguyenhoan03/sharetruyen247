...
class DanhmuccategoryController extends Controller
{
    ...
    public function tienhiep(){
        $data = $this->dm_Service->data_pageCategory('tienhiep');
